<header class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap
    w-full bg-white text-sm py-3 md:py-0 dark:bg-gray-800 shadow-md">
          ...
          <div
            ...
            <div class="relative">
              <button onclick="toggleDropdown()"
               ...
               {{ Auth::user()->name }}
                <!-- Dropdown Arrow Icons (Hidden/Shown Dynamically) -->
                <svg id="arrowDown" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform duration-300"
                ...
                <svg id="arrowUp" xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 transition-transform duration-300 hidden" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
            ...
            <div id="dropdownMenu"
              class="fixed top-16 left-2/2 transform -translate-x-2/2 w-38 bg-white border rounded shadow-lg hidden z-50">
              <a wire:navigate href="/my-orders" class="block px-4 py-2 hover:bg-gray-200">My Orders</a>
              <a href="#" class="block px-4 py-2 hover:bg-gray-200">My Account</a>
...
<script>
        ...
        // If dropdown is open, listen for clicks outside to close it
        if (isHidden) {
    ...
    function closeDropdownOnClickOutside(event) {
        ...
        // If the click is outside both the dropdown and the button, close the dropdown
